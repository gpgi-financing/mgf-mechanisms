  function [ Y ] = resultingAllocationCORSIA(S,A,F,C,r,R,reductionInOilRevenuesPerDollarRaisedViaTaxesOnFlightEmissions,AggregateMitigationBenefitsDueToKerosineConsumptionDecrease)
...
ResultingAllocations=zeros(1,6);
ResultingAllocations(1)=(1-r)*aggregateMoneyRaisedForGPGIs/2;
ResultingAllocations(4)=(1-r)*aggregateMoneyRaisedForGPGIs/2;
